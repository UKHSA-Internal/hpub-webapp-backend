...
class UserSerializer(serializers.ModelSerializer):
    ...
    def to_model(self):
        ...
        if name:
            try:
                self.validated_data["organization_ref"] = Organization.objects.get(name=name)
        ...
        if name:
            try:
                self.validated_data["establishment_ref"] = Establishment.objects.get(name=name)
        ...
        self.validated_data['slug'] = slugify(f"user-{self.validated_data['email']}-{self.validated_data['user_id']}")
