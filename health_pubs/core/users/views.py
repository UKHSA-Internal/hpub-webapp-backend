...
class UserLoginView(APIView):
    ...
    def post(self, request):
        ...
        if role_ref:
            print("Role found:", role_ref)
            print("Role name:", role_ref.name)
            role_name = role_ref.name
        else:
            print("No role found for role_ref:", user.role_ref)
            role_name = None

        # Retrieve organization
        organization_ref = user.organization_ref
        if organization_ref:
            print("Organization found:", organization_ref)
            print("Organization name:", organization_ref.name)
            organization_name = organization_ref.name
        else:
            print("No role found for organization_ref:", user.organization_ref)
